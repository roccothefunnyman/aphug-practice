...
**60 Multiple-Choice Questions | Suggested Time: 60 minutes**

These questions are original, written to match the style, difficulty, and content distribution of the College Board's AP Human Geography exam, based on the Course and Exam Description (CED). They are not copied from any official or commercial test.

**Recommended pacing:** about 1 minute per question. If unsure, mark and move on; come back at the end.
...
### Question 1
A textbook published in the early 1900s claims that tropical climates inevitably produce slow-paced cultures, while temperate climates breed industrious societies. This argument is most clearly an example of:
...
### Question 3
**Voter Turnout, Hypothetical 2024 Election**

| Scale | Turnout |
|---|---|
| United States (national) | 64% |
| Ohio (state) | 71% |
| Cuyahoga County | 67% |
| City of Cleveland | 49% |
...
### Question 10
**Median Household Income, Greater Cleveland Area (hypothetical)**

| Scale | Median Income |
|---|---|
| Cleveland Metropolitan Area | $78,000 |
| Cuyahoga County | $62,000 |
| City of Cleveland | $38,000 |
| Hough neighborhood | $24,000 |
...
### Question 11
Which of the following is the strongest example of a vernacular region?

A) The European Union
B) The metropolitan delivery zone of a regional newspaper
C) "The Midwest" in the United States
D) The watershed of the Mississippi River

---

### Question 12
A small port city is located on a deep natural harbor and lies along major shipping lanes connecting Asia and Europe. The harbor is an example of *site*, while the position along shipping lanes is an example of:
...
### Question 13
Which type of thematic map would best display the percentage of households below the poverty line by U.S. county?

A) Dot density map
B) Choropleth map
C) Isoline map
D) Cartogram showing land area
...
### Question 15
**Approximate Travel Time, New York City to London**

| Year | Mode | Travel Time |
|---|---|---|
| 1850 | Sailing ship | ~14 days |
| 1900 | Steamship | ~6 days |
| 1950 | Propeller airliner | ~14 hours |
| 2000 | Jet airliner | ~7 hours |
| 2020 | Jet airliner | ~7 hours |

The pattern in the table best illustrates:

A) Distance decay
B) Time-space convergence
C) Increasing friction of distance
...
### Question 16
A country is currently experiencing a sharp drop in birth rates while death rates have already declined to low levels, producing slow population growth. This country is most likely in which stage of the demographic transition model?
...
### Question 18
Which combination is best described as a push-pull pair driving international migration?

A) Pull: civil war in origin country / Push: job opportunities in destination
B) Push: civil war in origin country / Pull: job opportunities in destination
C) Push: family reunification in destination / Pull: religious persecution in origin
D) Pull: drought in origin country / Push: educational opportunities in destination

---

### Question 19
**Demographic Indicators, Country M (hypothetical)**
...
Country M is most likely:

A) A high-income country in Stage 4 of the demographic transition
B) A Sub-Saharan African country in Stage 2 with high natural increase
C) A country experiencing sub-replacement fertility
D) A country with a heavily aging population

---

### Question 20
A population pyramid shows a very wide base (large numbers of children ages 0–14), a steadily narrowing middle, and a small elderly population, with roughly symmetrical sides for males and females. This pyramid is most consistent with which type of country?

A) A high-income country in Stage 4 of the demographic transition
B) A country in Stage 2 with high fertility and declining mortality
C) A country experiencing significant male labor out-migration
D) A country in Stage 5 with sub-replacement fertility

---

### Question 21
A family fleeing violence in Syria and crossing into Jordan to seek safety is best classified as:

A) Voluntary economic migrants
B) Refugees, a category of forced migration
...
### Question 23
Día de los Muertos in Mexico combines pre-Columbian Indigenous beliefs about honoring the dead with Catholic observances tied to All Saints' Day and All Souls' Day. This blending of religious and cultural traditions is best described as:

A) Cultural assimilation
B) Cultural syncretism
C) Relocation diffusion only
D) Cultural extinction

---

### Question 24
A neighborhood association paints murals on local buildings, installs benches and planters, and organizes a weekly farmers' market in a previously underused public square. This activity is best described as:
...
### Question 26
Which of the following is the best example of a culture trait?

A) The complete set of behaviors and beliefs of a society
B) The use of chopsticks for eating
C) A region defined by shared cultural characteristics
D) The blending of two cultures over time
...
### Question 31
Indonesia, made up of thousands of islands spread across a vast area of ocean, is the clearest example of which type of state shape?
...
### Question 34
The boundary between North and South Korea, drawn after the Korean War with little regard for preexisting cultural or physical features, is best classified as:

A) An antecedent boundary
B) A subsequent boundary
C) A superimposed boundary
D) A relict boundary

---

### Question 35
The Scottish Parliament's powers over education, health, and certain taxes within the United Kingdom are an example of:
...
|---|---|
| Population | Doubles every 25 years (geometric) |
| Food production | Increases by a fixed amount every 25 years (arithmetic) |

The relationship shown above was central to Thomas Malthus's prediction that:

A) Technological innovation would always allow food supply to outpace population
B) Population would inevitably outstrip food supply, leading to crisis
C) Urbanization would solve agricultural shortages
D) Birth rates would naturally fall as societies industrialized
...
### Question 39
**Von Thünen's Model (description)**
Imagine an isolated city surrounded by a flat, uniform plain with one market and uniform transportation costs in all directions. The model predicts a series of concentric rings of agricultural land use moving outward from the city.
...
### Question 41
**Country X, Top 5 Exports by Value (hypothetical)**

| Export | % of Total Export Value |
|---|---|
| Cocoa | 38% |
| Crude petroleum | 12% |
| Rubber | 9% |
...
### Question 42
**Two Farms (hypothetical)**

| Feature | Farm A | Farm B |
|---|---|---|
| Size | 12,000 acres | 80 acres |
| Workers | 4 | 12 |
| Output per acre | Low | High |
| Primary product | Wheat | Mixed vegetables |

Based on the table, Farm A is best classified as:

A) Intensive subsistence agriculture
B) Extensive commercial agriculture
C) Plantation agriculture
D) Mediterranean polyculture
...
### Question 49
**Country Y, Population of Five Largest Cities (hypothetical, in millions)**
...
This urban hierarchy most clearly illustrates:

A) The rank-size rule
B) A primate city pattern
C) A balanced gravity-model distribution
D) A central place hierarchy with full nesting
...
### Question 53
**Selected Indicators (hypothetical, two countries)**

| Indicator | Country P | Country Q |
|---|---|---|
| Maternal mortality ratio | 6 per 100,000 | 410 per 100,000 |
| Adolescent birth rate | 8 per 1,000 | 95 per 1,000 |
| Seats in parliament held by women | 42% | 11% |
| Female labor force participation | 67% | 22% |
...
### Question 57
**Employment by Sector, Country Z (hypothetical)**

| Sector | 1960 | 2020 |
|---|---|---|
| Primary (agriculture, mining) | 38% | 4% |
| Secondary (manufacturing) | 41% | 17% |
| Tertiary (services) | 18% | 63% |
| Quaternary (information) | 3% | 16% |
...
### Question 60
Two countries trade because Country A can produce wheat at lower opportunity cost than Country B, while Country B can produce textiles at lower opportunity cost than Country A. This pattern is best explained by:
